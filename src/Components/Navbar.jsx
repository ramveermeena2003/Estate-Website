...
const Navbar = () => {
    ...
    return (
        <div className='fixed top-0 left-0 w-full z-10 bg-black  bg-opacity-70'>
            ...
            {/* ----------------mobile - menu ----------------*/}
            <div className={`md:hidden ${showMobileMenu ? 'fixed w-full sm:w-1/2' : 'h-0 w-0'} right-0 bottom-0 top-0 overflow-hidden bg-white transition-all`}>
                ...
                <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                    ...
                    <a onClick={()=>{setShowMobileMenu(false)}} href="#Projects" className='px-4 py-2 inline-block'>Projects</a>
                    <a onClick={()=>{setShowMobileMenu(false)}} href="#Testimonials" className='px-4 py-2 inline-block'>Testimonials</a>
                    <a onClick={()=>{setShowMobileMenu(false)}} href="#Contact" className='px-4 py-2 inline-block'>Contact Us</a>
                </ul>
            </div>
        </div>
    )
